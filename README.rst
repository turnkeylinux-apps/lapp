...
PostgreSQL (instead of MySQL), PHP, Python and Perl.

This appliance includes all the standard features in `TurnKey Core`_,
and on top of that:

- SSL support out of the box.
- Apache PHP support, Python and Perl CGI support, and PostgreSQL client
  libraries for PHP, Python and Perl.
- PHP development helpers:

    - composer_ installed globally (/usr/bin/composer) from Debian.
